...
function toggleAnswer5() {
  var answer5Display = document.getElementById("resposta5").style.display;

  if (answer5Display == "none") {
...
function toggleAnswer6() {
  var answer6Display = document.getElementById("resposta6").style.display;

  if (answer6Display == "none") {
...
function toggleAnswer7() {
  var answer7Display = document.getElementById("resposta7").style.display;

  if (answer7Display == "none") {
